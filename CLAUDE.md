...
Project-level governance for PeasyPilot. This file complements, and does not
replace, the global instructions at `C:\Users\DevOps\.claude\CLAUDE.md` — read that
one too; where the two disagree, the global file wins.
...
6. `.agents/04_LANGUAGE_SPECIFIC.md` — C#/.NET conventions for this repo
7. `.agents/05_ARCHITECTURE.md` — package layout and responsibilities
